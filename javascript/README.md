...
The Home customisation stack is handled by the four numbered entries below. `notifysync-loader.js` is kept alongside them for the NotifySync integration.

## Load order

| Order | Injector name | File | Purpose |
| ---: | --- | --- | --- |
| 1 | `NotifySync Loader` | [`notifysync-loader.js`](notifysync-loader.js) | Loads the NotifySync frontend script when that integration is enabled |
